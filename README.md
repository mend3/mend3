...
flowchart LR
  ...
  c_egress_proxy["Egress Proxy"]:::cap
  ...
  c_web_scraping["Web Scraping"]:::cap
  d_ads["Ads"]:::dom
  ...
  c_egress_proxy -->|provided-by| p_core_proxy
  ...
  c_web_scraping -->|provided-by| p_core_proxy
  ...
  v_data_plane -->|includes| p_core_knowledge_engine
  v_data_plane -->|includes| p_core_proxy
